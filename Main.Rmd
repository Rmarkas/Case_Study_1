...
We assume that the 5 quantiles desired are for GDP sorted in ascending order. This way, we can assume that the highest quantile (quantile 5) is the group of countries with the highest GDP.
